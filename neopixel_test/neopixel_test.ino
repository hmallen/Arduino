...
void loop() {
  //hello_there_gillian("blue");
  //delay(2000);
  //looking_lovely_today("blue");
  //delay(2000);
  //been_watching_you("blue");
...
void eyesAction(String state, String colorOuter, String colorInner) {
  ...
  if (state == "open") {
    ...
    strip_eyes.setPixelColor(2, eyesColorInner);
    strip_eyes.setPixelColor(3, eyesColorOuter);
    strip_eyes.setPixelColor(4, eyesColorOuter);
    strip_eyes.setPixelColor(5, eyesColorInner);
...
uint32_t colorPicker(String strip, String color) {
  if (strip == "eyes") {
    ...
    if (color == "red") mouth_color = strip_eyes.Color(255, 0, 0);
    else if (color == "green") mouth_color = strip_eyes.Color(0, 255, 0);
    else if (color == "blue") mouth_color = strip_eyes.Color(0, 0, 255);
    else if (color == "yellow") mouth_color = strip_eyes.Color(255, 255, 0);
    else if (color == "cyan") mouth_color = strip_eyes.Color(0, 255, 255);
    else if (color == "magenta") mouth_color = strip_eyes.Color(255, 0, 255);

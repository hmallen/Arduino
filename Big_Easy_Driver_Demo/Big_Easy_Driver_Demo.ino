...
void StepForwardDefault()
{
  ...
  for (x = 1; x < 1250; x++) //Loop the forward stepping enough times for motion to be visible
  {
...
void ReverseStepDefault()
{
  ...
  for (x = 1; x < 1250; x++) //Loop the stepping enough times for motion to be visible
  {
